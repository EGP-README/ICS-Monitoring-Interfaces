...
class Indicator:
    """
        This object allows for state transofrmations of images. Some images have binary states
        such as unlocked and locked or open and closed. Here we use contain this operation
        and use pygame for accuate object flipping and placement
    """
